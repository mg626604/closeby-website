      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Emergency Alert Log</h2>
          </div>
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">
            CloseBY automatically detects, de-escalates, and connects the caregiver for monitored events.
          </p>
        </div>
      </div>
          ...
          alerts.map((alert) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-[11px] text-slate-600 dark:text-slate-400 mt-2">
                    ...
                    <span>•</span>
                    <span className="text-slate-600 dark:text-slate-400">Location: {alert.location}</span>
                  </div>

                  <div className="mt-2 text-[11px] font-medium text-slate-700 dark:text-slate-300">
                    <span>Call Status: </span>
                    <span className={alert.callStatus === 'Incoming Call' ? 'text-amber-500' : 'text-emerald-500'}>
                      {alert.callStatus === 'Incoming Call' ? '🟠 Incoming Call' : '🟢 Connected'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                ...
                {alert.callStatus === 'Incoming Call' && (
                  <button
